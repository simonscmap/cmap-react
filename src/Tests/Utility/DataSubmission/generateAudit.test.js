...
describe('Validations work as expected', () => {
    ...
    let codeFriendly = validations.var_short_name[0];
    let releaseDate = validations.dataset_release_date[0];
    ...
    test('Length validation works as expected', () => {
        ...
        expect(length('abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz')).toBeTruthy();
    });
