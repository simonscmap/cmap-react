...
export const VIZ_PAGE_DATA_TARGET_DETAILS_STORE = 'VIZ_PAGE_DATA_TARGET_DETAILS_STORE';
export const VIZ_PAGE_DATA_TARGET_SET_AND_FETCH_DETAILS = 'VIZ_PAGE_DATA_TARGET_SET_AND_FETCH_DETAILS';
...
export const VARIABLE_NAME_AUTOCOMPLETE_STORE = 'VARIABLE_NAME_AUTOCOMPLETE_STORE';

export const VARIABLE_FETCH = 'VARIABLE_FETCH';
export const VARIABLE_STORE = 'VARIABLE_STORE';
export const VARIABLE_FETCH_SET_LOADING_STATE = 'VARIABLE_FETCH_SET_LOADING_STATE';
...
export const SPARSE_DATA_MAX_SIZE_NOTIFICATION_UPDATE = 'SPARSE_DATA_MAX_SIZE_NOTIFICATION_UPDATE';

export const HANDLE_GUEST_VISUALIZATION = 'HANDLE_GUEST_VISUALIZATION';

export const GUEST_PLOT_LIMIT_NOTIFICATION_SET_IS_VISIBLE = 'GUEST_PLOT_LIMIT_NOTIFICATION_SET_IS_VISIBLE';
