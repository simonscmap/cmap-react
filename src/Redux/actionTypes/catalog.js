...
export const FETCH_TABLES_WITH_ANCILLARY_DATA_SEND =
  'FETCH_TABLES_WITH_ANCILLARY_DATA_SEND';
export const FETCH_TABLES_WITH_ANCILLARY_DATA_SUCCESS =
  'FETCH_TABLES_WITH_ANCILLARY_DATA_SUCCESS';
export const FETCH_TABLES_WITH_ANCILLARY_DATA_FAILURE =
  'FETCH_TABLES_WITH_ANCILLARY_DATA_FAILURE';

export const TABLES_WITH_ANCILLARY_DATA_STORE =
...
export const FETCH_TABLES_WITH_CI_SEND =
  'FETCH_TABLES_WITH_CI_SEND';
export const FETCH_TABLES_WITH_CI_SUCCESS =
  'FETCH_TABLES_WITH_CI_SUCCESS';
export const FETCH_TABLES_WITH_CI_FAILURE =
  'FETCH_TABLES_WITH_CI_FAILURE';

export const TABLES_WITH_CI_STORE =
