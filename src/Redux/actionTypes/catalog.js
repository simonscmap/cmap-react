...
export const FETCH_ANCILLARY_DATA_SEND = 'FETCH_ANCILLARY_DATA_SEND';
export const FETCH_ANCILLARY_DATA_SUCCESS = 'FETCH_ANCILLARY_DATA_SUCCESS';
export const FETCH_ANCILLARY_DATA_FAILURE = 'FETCH_ANCILLARY_DATA_FAILURE';

export const ANCILLARY_DATA_STORE = 'ANCILLARY_DATA_STORE';
