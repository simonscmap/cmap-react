...
const guideItems = {
    dataItems: [
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    These columns represent the dataset variables (measurements). Please rename them as appropriate for your data.
    ...
    datasetMetadataItems: [
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    ...
                    catalog (<Link href='#fig-2'>Fig.2</Link>) and visualization search dialog (<Link href='#fig-3'>Fig.3</Link>). 
                    ...
                    associated with a cruise, we recommend including the official cruise and the cruise nickname in the
                    dataset_long_name. For example: Underway CTD Gradients 3 KM1906. Capitalizing the dataset_long_name is also recommended.
                </React.Fragment>
                ],
                plainText: [`The dataset_long_name is a descriptive and human-readable name for the dataset. This name will identify your dataset in the CMAP 
            ...
            images: [            
                ...
                },
                {
                    ...
                    caption: 'Figure 3. The "dataset_long_name" appears in the visualization page search dialog.',
                    id: 'fig-3'
                },
            ]
        },
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    Specifies the group and/or the institute name of the data owner(s). Including the PI name is strongly recommended, 
                    and the field can also include any link (such as a website) to 
                    the data producers. This information will be visible in the CMAP catalog as shown in <Link href='#fig-4'>Fig 4</Link>. 
                    Also, dataset_source will be annotated to any visualization made using the dataset (<Link href='#fig-5'>Fig. 5</Link>).
                </React.Fragment>
                ],
            plainText: [`
            ...
            images: [
                ...
                },
                {
                    ...
                    caption: 'Figure 5. The "dataset_source" appears in visualizations made using the corresponding dataset (enclosed in the orange rectangle).',
                    id: 'fig-5'
                }
            ]
        },
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    Please specify how your dataset should be acknowledged when used. You may mention your funding agency, grant number, or 
                    you may ask those that use your data to acknowledge your dataset with a particular statement or citation. Dataset 
                    acknowlegment will be visible in the catalog page (<Link href='#fig-6'>Fig. 6</Link>).
                </React.Fragment>
            ],
            plainText: [`
            ...
            images: [
                {
                    ...
                    caption: 'Figure 6. A sample dataset shown in the Simons CMAP catalog. The "dataset_acknowledgement" is enclosed in the orange rectangle.',
                    id: 'fig-6'
                }
            ]
        },
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    ...
                    overview of any larger sampling program if applicable (<Link href='#fig-7'>Fig. 7</Link>).
                </React.Fragment>
            ],
            plainText: [`
                Your description serves as the dataset documentation visible in the Simons CMAP catalog and helps users 
            ...
            images: [
                {
                    ...
                    caption: 'Figure 7. Example of a dataset description visible in the CMAP catalog.',
                    id: 'fig-7'
                }
            ]
        },
    ...
    variableMetadataItems: [
            ...
            images: [
                {
                    ...
                    caption: 'Figure 9. A sample dataset shown in the Simons CMAP catalog. The "var_short_name" is highlighted in the orange rectangle.',
                    id: 'fig-9'
                }
            ]
        },
        {
            ...
            text: [
                <React.Fragment>
                    ...
                    name will present your variable in the CMAP catalog (<Link href='#fig-10'>Fig. 10</Link>), visualization search dialog 
                    (<Link href='#fig-11'>Fig. 11</Link>), and will appear as the title of figures generated on the vizualization page. 
                    var_long_name can contain any unicode character, but please avoid names 
            ...
            images: [
                {
                    ...
                    caption: 'Figure 10. A sample dataset shown in the Simons CMAP catalog. The "var_long_name" is highlighted in the orange rectangle.',
                    id: 'fig-10'
                },
                {
                    src: '/images/cmap_variable_long_name_on_viz_page.png',
                    alt: 'var long name in visualization page',
                    caption: 'Figure 11. The "var_long_name" appears in the visualization page search dialog.',
                    id: 'fig-11'
                }
            ]
        },
        {
            ...
            text: [
                <React.Fragment>
                    This is a required field that refers to the instrument used to produce the measurements such as CTD, fluorometer, 
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    ...
                    catalog (see <Link href='#fig-10'>Fig. 10</Link>) and in the generated visualizations (see <Link href='#fig-5'>Fig. 5</Link>).
                </React.Fragment>
            ],
            plainText: [`
            In this column, enter the units of each variable, if applicable. Leave this field blank if your variable is unitless (e.g. “station numbers” or “quality 
        ...
        },
        {
            ...
            text: [
                <React.Fragment>
                    Use this field to communicate any detailed information about this particular variable with the users. 
                    Examples of a comment could include but are not limited to: a description of method(s) used to process raw 
                    ...
                    catalog (<Link href='#fig-12'>Fig. 12</Link>).
                </React.Fragment>
            ],
            plainText: [`
            ...
            images: [
                {
                    ...
                    caption: 'Figure 12. A sample dataset shown in the Simons CMAP catalog with the Comment column highlighted in the orange rectangle. If short enough, the "var_comment" is shown in the cell on the catalog page, otherwise it is accessible using the "View Comment" link.',
                    id: 'fig-12'
                }
            ]
        }
