...
import { calculateRowCounts } from '../../../../rowCount';
import {
...
const useSpatialTemporalSearchStore = create((set, get) => ({
  ...
  search: async () => {
    ...
    try {
      ...
      // calculateRowCounts handles: tracking dataset IDs, estimating eligible datasets
      ...
      calculateRowCounts(enhancedResults, estimationConstraints);
    } catch (error) {
      set({
        isSearching: false,
