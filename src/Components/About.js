    ...
    <Page2 pageTitle={'About Simons CMAP'} bgVariant="slate2">
      ...
      <Section>
        <div className={classes.aboutWrapper}>
          ...
          <Accordion expanded={expanded === sections.people} onChange={handleChange (sections.people)} data-focus={sections.people}>
          ...
          <Accordion expanded={expanded === sections.cite} onChange={handleChange (sections.cite)} data-focus={sections.cite}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Accordion expanded={expanded === sections.participate} onChange={handleChange (sections.participate)} data-focus={sections.participate}>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
