...
const WarningColor = '#102133';
const SuccessColor = 'rgb(34, 163, 185)';
...
const generateTemporaryId = (newsId) => {
  return `${newsId}:${(Math.random () * 1000000).toString().slice(0,6)}`;
};
...
const ConfirmationDialog = (props) => {
  ...
  useEffect (() => {
    setTempId (generateTemporaryId (newsId))
  }, [open]);
