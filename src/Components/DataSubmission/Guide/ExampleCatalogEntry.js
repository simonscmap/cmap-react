...
const mockDataset = {
  ...
  Icon_URL:
    'https://raw.githubusercontent.com/simonscmap/static/master/mission_icons/tblInflux_Underway_TN428_2024v1_0.png',
  ...
  Sensors: ['Flow Cytometer'],
  Visualize: 1,
  Row_Count: 14,
  Regions: 'Indian Ocean,South Pacific Ocean',
  References:
    'https://github.com/fribalet/FCSplankton$$$https://doi.org/10.5281/zenodo.12636479',
  DataFeatures: [],
};
