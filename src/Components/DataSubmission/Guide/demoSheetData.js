...
const columnNames =     ['time','lat','lon','depth','station','extracted_chl_a','quality_value_chl_a','extracted_phaeopigments','quality_value_phaeopigments'];
 const sampleDataColumns = columnNames.map(term => ({ prop: term, name: term }));
...
const metaColNames = ['dataset_make','dataset_source','dataset_distributor','dataset_acknowledgement','contact_email','dataset_history','dataset_description','dataset_references','climatology','cruise_names'];
...
const varColNames = ['var_short_name','var_long_name','var_sensor','var_unit','var_spatial_res','var_temporal_res','var_discipline','visualize','var_keywords','var_comment'];

const varCols = varColNames.map(term => ({ prop: term, name: term }));

const varData = [
  ['station','Station','','','irregular','irregular','biology','0','Atlantic Meridional Transect, AMT01, JR19950921, British Oceanographic Data Centre, BODC, fluorometer,cruise, in-situ, insitu, atlantic ocean', ''],
  ['extracted_chl_a','Extracted Chlorophyll A','Fluorometer','mg/m3','irregular','irregular','biology','1','Atlantic Meridional Transect, AMT01, JR19950921, British Oceanographic Data Centre, BODC, fluorometer, extracted chlorophyll a, chlorophyll, biology, cruise, in-situ, insitu, atlantic ocean','Turner-10 Fluorometer'],
  ['quality_value_chl_a','Quality Value Chlorophyll A','','','irregular','irregular','biology','0','Atlantic Meridional Transect, AMT01, JR19950921, British Oceanographic Data Centre, BODC, fluorometer, cruise, in-situ, insitu, atlantic ocean','SeaDataNet Quality Control Flags key: 1 = good value, 3 = probably bad value'],
  ['extracted_phaeopigments','Extracted Phaeopigments','Fluorometer','ng/L','irregular','irregular','biology','1','Atlantic Meridional Transect, AMT01, JR19950921, British Oceanographic Data Centre, BODC, fluorometer, extracted phaeopigments, phaeopigments, biology, cruise, in-situ, insitu, atlantic ocean','Turner-10 Fluorometer'],
  ['quality_value_phaeopigments','Quality Value Phaeopigments','','','irregular','irregular','biology','0','Atlantic Meridional Transect, AMT01, JR19950921, British Oceanographic Data Centre, BODC, fluorometer, cruise, in-situ, insitu, atlantic ocean','SeaDataNet Quality Control Flags key: 1 = good value, 3 = probably bad value'],
];
