  ...
  return (
    <FocusManager focus={focus} className={cl.container} >
      ...
      <AccordionSection
        ...
        title={'My dataset is larger than 150 MB. How should I prepare my data?'}
      >
        <Typography>
      ...
      <AccordionSection
        state={state}
        name={foci.steps}
        title={'What are the steps for adding a dataset to Simons CMAP? Who is responsible for each step?'}
      >
      ...
      <AccordionSection
        state={state}
        name={foci.varnames}
        title={'What should I watch for when selecting the dataset/variable names?'}
      >
        <Typography>
      ...
      <AccordionSection
        ...
        title={'How do I include multiple references on the dataset metadata sheet?'}
      >
        <Typography>
      ...
      <AccordionSection
        ...
        title={'How do I submit an updated version of a dataset already included in CMAP?'}
      >
        <Typography>
      ...
      <AccordionSection
        ...
        title={'How do I update a dataset that has been submitted and is in the review process?'}
      >
        <Typography>
      ...
      <AccordionSection
        ...
        title={'Can I submit my dataset for inclusion in Simons CMAP, but prevent public access until my publication is released?'}
      >
        <Typography>
