    ...
    <div className={cl.container}>
      ...
      <List>
        <ListItem>
          ...
          <ListItemText>
            Pre-submission, the <GuideLink hash="#validation-api">CMAP Validation API</GuideLink> is available for users to use to check and update their own datasets. Use of the CMAP Validation API prior to dataset submission expedites the dataset submission and review process. Use of this tool before dataset submission is optional.
          </ListItemText>
        </ListItem>
        <ListItem>
          <ListItemIcon><RxDotFilled/></ListItemIcon>
        ...
        <ListItem>
          <ListItemIcon><RxDotFilled/></ListItemIcon>
          <ListItemText>
            Post-submission, the <GuideLink hash="#validation-api">CMAP Validation API</GuideLink> is the primary tool used by the CMAP data curation team for reviewing datasets. Datasets also undergo human-based quality checks.
          </ListItemText>
        </ListItem>
      </List>
    </div>
