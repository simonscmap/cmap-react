...
class CatalogSearch extends React.Component {
    ...
    RefreshByQuerystring = () => {
        if(this.props.location.search) {
            ...
            ['region', 'sensor', 'make'].forEach(s => params[s] = typeof params[s] === 'string' ? [params[s]] : params[s]);
            let newState = {
                ...params,
    ...
    pushHistory = debounce(1500, (qstring) => this.props.history.push('/catalog?' + qstring));
            ...
            <Paper elevation={4} className={classes.searchPaper}>
                <Grid container justify='center' alignItems='center'>
                    ...
                    <Grid item xs={12} className={classes.searchPanelRow}>
                        <Button variant='outlined' onClick={this.handleResetSearch} className={classes.resetButton} id="catSearchReset">
                            Reset Filters
                        </Button>
                    </Grid>
...
export default connect(mapStateToProps)(withStyles(styles)(withRouter(CatalogSearch)));