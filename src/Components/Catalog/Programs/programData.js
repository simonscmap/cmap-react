export const data = {
  Gradients: {
    ...
    blurb: 'The SCOPE-Gradients program is designed to test conceptual and mathematical models of biogeochemical organization across the transition zone between different ecosystems. Our studies are grounded by three hypotheses derived from ecological theory and manifested by the Darwin ecosystem model output.'
  },
  CBIOMES: {
    ...
    logo: 'cmap-sponsor-CBIOMES-COLORED.png',
  },
  SCOPE: {
    ...
    'logo': 'cmap-sponsor-SCOPE-COLORED.png',
  },
  HOT: {
