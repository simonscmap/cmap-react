...
const SearchHelpContents = (props) => {
  return (
    <React.Fragment>
      ...
      <Typography>
        Use the keyboard or mouse to select a keyword from the list, or press
        enter to use the typed keyword as is.
      </Typography>
      ...
      <Typography>
        Press escape to clear the keyword field, or backspace to remove the most
      ...
      <Typography style={{ marginTop: '12px' }}>
        <strong>Sensors</strong> such as satellite, flow cytometer, or sediment
        trap.
      </Typography>
