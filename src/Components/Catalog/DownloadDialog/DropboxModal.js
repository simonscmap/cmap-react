          ...
          {vaultLink &&
           <div className={classes.infoContainer}>
             ...
             <div className={classes.alertContainer}>
               <CustomAlert severity="info" className={classes.infoAlert}>Note that if you have disabled 3rd party cookies or have certain browser extensions that block 3rd party scripts, downloading files through this Dropbox plugin may not work. In that case, please follow the <a href={vaultLink.shareLink} target="_blank">external link to view the files on Dropbox.com</a>.</CustomAlert>
             </div>
           </div>}
        </DialogTitle>
