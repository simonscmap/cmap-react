    ...
    <Paper className={classes.paper}>
      {emailWasSent ? (
        <Typography className={classes.emailSentDescription}>
          An email has been sent to {email}. If you don't receive anything from
          us within the next few minutes please check your spam folder.
        </Typography>
      ) : (
        <React.Fragment>
          <Typography className={classes.description}>
            Enter your email address below to recover your username and
            password.
          </Typography>
