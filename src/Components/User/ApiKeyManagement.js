      ...
      <div className={classes.wrapper}>
        {this.props.apiKeys ? (
          <Paper className={classes.root} elevation={6}>
            <Typography
              variant="subtitle1"
              className={classes.apiKeyTableHeader}
            >
              Your API Key
            </Typography>
            <Divider />
              ...
              <TableBody>
                {this.props.apiKeys.map((apiKey, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell
                      align="center"
                      className={classes.showChildOnHover}
                    >
                      <CopyableText
                        text={apiKey.Api_Key}
        ...
        <Paper className={classes.root} elevation={6}>
          <Typography variant="body2">Generate a new API key</Typography>
          <Grid
            container={true}
            alignItems="center"
          ...
          >
            <Grid item>
              <Tooltip
                placement="bottom"
                title="Optionally Add a Custom Description"
              >
                <TextField
                  margin="normal"
                  id="description"
          ...
          {this.props.apiKeyCreationState === states.failed ? (
            <span>Key creation failed</span>
          ) : (
            ''
          )}
        </Paper>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(styles)(ApiKeyManagement));
