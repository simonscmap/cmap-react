    ...
    return (
      <React.Fragment>
        <ChangePassword
          ...
          close={() =>
            this.setState({ ...this.state, changePasswordDialogOpen: false })
          }
        />
        <ChangeEmail
          open={changeEmailDialogIsOpen}
          close={() =>
            this.setState({ ...this.state, changeEmailDialogOpen: false })
          }
        />
                ...
                <TextField
                  ...
                  helperText={
                    this.state[property].valid
                      ? ''
                      : userProperties[property].requirement
                  }
                  key={index}
