/* Variable Search Overlay

   Allows user to select a variable from the catalog,
   for rendering a Chart or Plot.

   Consists in a search form with filters, and a list of matching results.
