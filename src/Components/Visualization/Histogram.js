...
const Histogram = (props) => {
  ...
  return (
    <React.Fragment>
      <ChartControlPanel downloadCsv={downloadCsv} chart={props.chart} />
      <Hint
        content={ModebarHint}
        position={{ beacon: 'right-start', hint: 'bottom-start' }}
        styleOverride={{ beacon: { top: '1em' } }}
      >
        <Plot
          style={{
            position: 'relative',
