...
class TopNavBar extends Component {
  ...
  render() {
    ...
    let cartSize =
      cart && Object.keys(cart).length ? Object.keys(cart).length : 0;
          ...
          <React.Fragment>
            ...
            <div>
              <Typography
                ...
                href="/"
                component="a"
                className={`${classes.navLink} ${classes.simonsLogoWrapper}`}
              >
                <img
                  src="/images/CMAP_white_logo_2.png"
                  width="40"
                  alt="CMAP logo"
                  className={classes.simonsLogo}
                />
              </Typography>
              <Typography
                variant="caption"
            ...
            <div className={classes.rightSectionWrapper}>
              <div>
                ...
                {cartSize > 0 ? (
                  <Typography
                    variant="caption"
                    onClick={() => this.props.setShowCart(true)}
                ...
                {showUserDropdownMenu ? (
                  <UserNavbarDropdown pathname={pathname} user={user} />
                ) : (
                  ''
                )}
                {showLogin ? (
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withRouter(withStyles(styles)(TopNavBar)));
