...
class ErrorBoundary extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        ...
        let browserInfo = `${info.browser.name || 'Unknown browser'} ${info.browser.version || 'Unknown version'}`;
        let osInfo = `${info.os.name || 'Unknown OS'} ${info.os.versionName || 'Unknown version'}`;
