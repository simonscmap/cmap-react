...
function buildSelectClause(includeRank = false, tableAlias = 'd', ftsAlias = 'fts', userBounds = null) {
  ...
  return `
    SELECT
      ...
      ${tableAlias}.${columns.timeMin}, ${tableAlias}.${columns.timeMax}, ${tableAlias}.${columns.temporalResolution}, ${tableAlias}.${columns.depthMin}, ${tableAlias}.${columns.depthMax},
